...
/**
  ...
  */
  class Com_supply_orderViewCategory extends JView
  {
...
//get the categories model, so we can use it also here
 $model =& JModel::getInstance('categories', 'com_supply_ordermodel');
 ...
 // Set some defaults if not set for params
  $params->def('comp_description', JText::_('COM_SUPPLY_ORDER_DESC'));
 ...
 // Use the static HTML library to build the image tag
  $category->image = JHTML::_('image', 'images/stories/'.$category->image, JText::_('COM_SUPPLY_ORDER'), $attribs);
  }
 ...
 $count = count($categories);
  ...
  {
  $cat =& $categories[$i];
  $cat->link = JRoute::_('index.php?option=com_com_supply_order&view=category&id='. $cat->slug);
  }
