...
jimport('joomla.application.component.model');
  ...
  class Com_supply_orderModelCategory extends JModel
  {
  /**
* Category id
*
...
var $_id = null;
 ...
 // Get the pagination request variables
  $this->setState('limit', $mainframe->getUserStateFromRequest('com_com_supply_order.limit', 'limit', $config->getValue('config.list_limit'), 'int'));
  ...
  */
  ...
  ' AND c.section = "com_com_supply_order"';
