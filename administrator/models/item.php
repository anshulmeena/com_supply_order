...
defined( '_JEXEC' ) or die( 'Restricted access' );
	...
	class Com_supply_orderModelItem extends JModel
	{
	/**
	* Item id
	*
	...
	*/
	...
	$cids = implode( ',', $cid );
	$query = 'DELETE FROM #__com_supply_order'
	. ' WHERE id IN ( '.$cids.' )';
	...
	*/
	...
	JArrayHelper::toInteger($cid);
	$cids = implode( ',', $cid );
	$query = 'UPDATE #__com_supply_order'
