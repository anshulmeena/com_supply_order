...
jimport( 'joomla.application.component.controller' );
 ...
 function save()
  {
  $this->store() ;
  $link = 'index.php?option=com_com_supply_order';
  $this->setRedirect( $link, $this->msg);
  }
 function apply()
  {
  $this->store() ;
  $link = 'index.php?option=com_com_supply_order&view=item&task=edit&cid[]=' . $this->id ;
  $this->setRedirect($link, $this->msg);
  }
 function remove()
  {
...
";
 ...
 $this->setRedirect( 'index.php?option=com_com_supply_order' );
  }
...
";
 ...
 $msg = 'New ordering saved';
  $this->setRedirect( 'index.php?option=com_com_supply_order', $msg );
  }
  }
