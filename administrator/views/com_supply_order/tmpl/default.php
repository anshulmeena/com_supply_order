...
<?php
  ...
  JToolBarHelper::title( JText::_( 'Com_supply_order' ), 'generic.png' );
  JToolBarHelper::publishList();
  JToolBarHelper::unpublishList();
  JToolBarHelper::deleteList();
  JToolBarHelper::editListX();
  JToolBarHelper::addNewX();
  JToolBarHelper::preferences('com_com_supply_order','550');
  ?>
...
<?php
  ...
  {
  $row = &$this->items[$i];
 $link = JRoute::_( 'index.php?option=com_com_supply_order&view=item&task=edit&cid[]='. $row->id );
 ...
 $row->cat_link = JRoute::_( 'index.php?option=com_categories&section=com_com_supply_order&task=edit&type=other&cid[]='. $row->catid );
  ?>
...
<input type="hidden" name="option" value="com_com_supply_order" />
