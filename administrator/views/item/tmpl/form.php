...
<table class="admintable" width="100%">
 <tr>
<td width="100" align="right" class="key">
<label for="com_supply_order">
<?php echo JText::_( 'Com_supply_order' ); ?>:
</label>
</td>
<td>
<input class="text_area" type="text" name="com_supply_order" id="com_supply_order" size="32" maxlength="250" value="<?php echo $this->item->com_supply_order;?>" />
</td>
</tr>
